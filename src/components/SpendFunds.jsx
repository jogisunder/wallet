...
export default class SpendFunds extends Component {
	constructor(props) {
		super(props);
		this.state = {
			user: "",
		...
		if (wallet.userId) {
			return (
				<div style={{ width: "50%", margin: "1rem auto" }}>
                    ...
                    <div style={seletedPartWraper}>
						<span>amout : </span>
						<input type="text" value={wallet.amount}></input>
					</div>
                    <div style={seletedPartWraper}>
						<span>Phone : </span>
			...
			<div>
                <form onSubmit={this.onSubmit}>
                    <Row style={{ alignContent:'center',display:'flex',justifyContent:'center'}}>
                        ...
                        <Col>
                            <input type="submit" value="Spend Funds" className="btn btn-primary" />
                        </Col>
                    </Row>
                </form>
				<Row>
